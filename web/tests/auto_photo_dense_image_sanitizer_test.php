...
$app1 = adis_segment(0xE1, "Exif\x00\x00orientation-kept");
...
$jpeg = "\xFF\xD8" . $app0 . $app1 . $app13 . $comment . $dqt . $sosHeader . $scan;
...
adis_ok(str_contains($sanitized, "Exif\x00\x00orientation-kept"), 'EXIF APP1 preserved');
adis_ok(str_contains($sanitized, 'comment-kept'), 'COM preserved');
