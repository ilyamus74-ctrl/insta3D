...
$script = $root . '/web/remote_station/scripts/analyze_tof_dense_frame_h27.py';

if (!is_file($script)) {
    fwrite(STDERR, "FAIL: missing H2.7 script\n");
    exit(1);
}

$text = file_get_contents($script);
if ($text === false) {
    fwrite(STDERR, "FAIL: cannot read H2.7 script\n");
    exit(1);
}
...
$required = [
    ...
    '--h26-rows',
    '--h26-report',
    'zone+distance median residualization',
    ...
    'DENSE_LOCAL_STRUCTURE_FRAME_PARTIAL_SUPPORT',
