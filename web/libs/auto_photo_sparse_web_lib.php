...
function auto_photo_sparse_web_enqueue_dense_preview(
    ...
    try {
        ...
        if (!$st || !$st->bind_param('iisiississsss',$orderId,$sparse['capture_session_id'],$type,$remote,$sparseRemote,$out,$status,$progress,$message,$result,$log,$mode,$json) || !$st->execute()) auto_photo_sparse_web_fail('dense_preview_insert_failed');
