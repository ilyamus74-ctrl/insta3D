...
internal object DualPhoneControlType {
    ...
    const val PING = "PING"
    const val PONG = "PONG"
    const val ENTER_WORK_MODE = "ENTER_WORK_MODE"
    const val ENTER_WORK_MODE_ACK = "ENTER_WORK_MODE_ACK"
    const val EXIT_WORK_MODE = "EXIT_WORK_MODE"
    const val EXIT_WORK_MODE_ACK = "EXIT_WORK_MODE_ACK"
    const val ENTER_CALIBRATION = "ENTER_CALIBRATION"
    const val ENTER_CALIBRATION_ACK = "ENTER_CALIBRATION_ACK"
    const val CALIBRATION_CAPTURE_AT = "CALIBRATION_CAPTURE_AT"
    const val CALIBRATION_CAPTURE_ACK = "CALIBRATION_CAPTURE_ACK"
