...
def main():
    ...
    q_valid_for_rotated_disparity=(baseline_axis=='horizontal'); depth_method='horizontal_q' if q_valid_for_rotated_disparity else 'vertical_rotated_manual_z'
